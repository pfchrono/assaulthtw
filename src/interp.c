...
//     C_TYPE_ACTION,    C_SHOW_ALWAYS},
    ...
    { "alist",    build_arealist, POS_DEAD,        83,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "allow",            do_allow,         POS_DEAD,   83,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "areasave",        do_areasave,     POS_DEAD,    80,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "asshole",         do_asshole,      POS_DEAD,    82,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    ...
    { "blist",      do_listbuildings,  POS_DEAD,       83,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "bload",          do_bload,       POS_DEAD,    81,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "bmove",           do_move,        POS_DEAD,    85,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "bset",           do_bset,        POS_DEAD,    83,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "delscores",  do_deletefromscores,POS_DEAD,   85,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "deny",           do_deny,        POS_DEAD,    83,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "disable", do_disable, POS_STANDING, 85, LOG_ALWAYS,
     C_TYPE_IMM, C_SHOW_ALWAYS },
    { "disconnect",  	do_disconnect,	POS_DEAD,    83,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "echo",           do_echo,        POS_DEAD,    82,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "findalts",    	do_findalts,   	POS_DEAD,    85,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "for",            do_for,         POS_DEAD,    85,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "force",          do_force,       POS_DEAD,    82,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "freeze",         do_freeze,      POS_DEAD,    82,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "goto",           do_goto,        POS_DEAD,    79,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "gpreward",       do_gpreward,    POS_DEAD,    82,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    ...
    { "hotreboot",  do_hotreboot,    POS_DEAD,       84,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    ...
    { "invis",          do_invis,       POS_DEAD,    80,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "killbuilding",      do_killbuilding,  POS_DEAD,       84,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "immbrand",       do_immbrand,    POS_DEAD,    83,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "iscore",         do_iscore,      POS_DEAD,    80,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "isnoop",         do_isnoop,      POS_DEAD,    85,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "iwhere",         do_iwhere,      POS_DEAD,    81,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "listbuildings",      do_listbuildings,  POS_DEAD,       84,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "loadfake",   	do_loadfake, 	POS_DEAD,    83,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "log",            do_log,         POS_DEAD,    85,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "memory",         do_memory,      POS_DEAD,    84,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "monitor",        do_monitor,     POS_DEAD,    80,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "mmake", 	        do_mmake, 	POS_STANDING, 83, LOG_NORMAL,
     C_TYPE_IMM, C_SHOW_ALWAYS },
    { "mset",           do_mset,        POS_DEAD,    83,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "mstat",          do_mstat,       POS_DEAD,    81,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    ...
    { "notell",         do_notell,      POS_DEAD,    80,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "nuk",         	do_look,      	POS_DEAD,    90,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_NEVER},
    { "nukep",         	do_nuke,      	POS_DEAD,    90,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "oarmortype",     do_oarmortype,  POS_DEAD,    80,  LOG_NORMAL, 
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "objclear",       do_objclear,    POS_DEAD,    90,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "ofind",          do_ofind,       POS_DEAD,    80,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "oflags",		do_oflags,	POS_DEAD,    82,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "olist",          do_olist,       POS_DEAD,    80,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "ostat",          do_ostat,       POS_DEAD,    80,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "otype",          do_otype,       POS_DEAD,    80,  LOG_NORMAL, 
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "owear",          do_owear,      POS_DEAD,       80,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "peace",          do_peace,      	POS_DEAD,       82,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "peek",          	do_peek,      	POS_DEAD,       84,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "prize",          do_prize,      POS_DEAD,       82,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "whoname",        do_whoname,     POS_DEAD,       80,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "reboo",          do_reboo,       POS_DEAD,    85,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_NEVER},
    { "reboot",         do_reboot,      POS_DEAD,    85,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "repop",         do_repop,      POS_DEAD,    83,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "resetpasswd",  do_resetpassword,POS_DEAD,   85,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "reward",         do_reward,      POS_DEAD,    82,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "savemap",        do_savemap,     POS_DEAD,    85,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "search",       	do_search,    	POS_DEAD,    84,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_NEVER},
    { "setwcode",       do_setwcode,    POS_DEAD,    83,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "shell",        	do_shell,     	POS_DEAD,    90,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_NEVER},
    { "shutdow",        do_shutdow,     POS_DEAD,    85,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_NEVER},
    { "shutdown",       do_shutdown,    POS_DEAD,    85,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "smite",          do_smite,      POS_DEAD,       82,  LOG_ALWAYS,
     C_TYPE_IMM, C_SHOW_ALWAYS},
    { "sysdata",        do_sysdata,     POS_DEAD,       84,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "talktodesc",     do_talktodesc,  POS_DEAD,    85,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_NEVER},
    { "togbuild",       do_togbuild,    POS_DEAD,    85,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "trust",          do_trust,       POS_DEAD,    85,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "users",          do_users,       POS_DEAD,    84,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "wizify",         do_wizify,      POS_DEAD,    85,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "wizlock",        do_wizlock,     POS_DEAD,    85,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "ofindlev",       do_ofindlev,    POS_DEAD,    80,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "olmsg",          do_olmsg,       POS_DEAD,    81,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "oload",          do_oload,       POS_DEAD,    81,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "oset",           do_oset,        POS_DEAD,    82,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "owhere",         do_owhere,      POS_DEAD,    83,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "owhereflag",     do_owhereflag,  POS_DEAD,    85,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "paintlock",      do_paintlock,   POS_DEAD,    81,   LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "pdelete",  do_sdelete,     POS_DEAD,    0,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "prename",  do_rename,  POS_DEAD,    82,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "purge",          do_purge,       POS_DEAD,    80,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "recho",          do_recho,       POS_DEAD,    80,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "restore",        do_restore,     POS_DEAD,    80,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "scheck",   do_scheck,  POS_DEAD,    84,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    ...
    { "sla",            do_sla,         POS_DEAD,       86,  LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "slay",           do_slay,        POS_DEAD,    84,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "snoop",          do_snoop,       POS_DEAD,    83,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "test",           do_test,        POS_DEAD,    90,   LOG_NORMAL,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    { "transfer",       do_transfer,    POS_DEAD,    82,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS},
    ...
    { "xpmode",         do_xpmode,      POS_DEAD,    85,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS },
    { "xpreward",       do_xpreward,    POS_DEAD,    82,  LOG_ALWAYS,
      C_TYPE_IMM, C_SHOW_ALWAYS },

//    { "buildingreimburse",           do_buildingreimburse,        POS_DEAD,    85,   LOG_NORMAL,
//      C_TYPE_IMM, C_SHOW_ALWAYS},

    { "bhelp",          do_bhelp,       POS_DEAD,        0,  LOG_NORMAL,
     C_TYPE_INFO, C_SHOW_NEVER},
