...
//	Name			Dam	BuildDam		Hit	Explode	Speed  	Type
    ...
    { "Acid", 			70, 	0, 			35, 	FALSE, 	2,	DAMAGE_ACID }, //Acid Sprayer
    { "Rockets", 		100, 	30, 			75, 	TRUE, 	30,	DAMAGE_BLAST }, //Hmmm... Tanks maybe?
    { "Railgun", 		10, 	4, 			75, 	FALSE, 	2,	DAMAGE_BULLETS }, //Vehicles
    { "Flame", 			40, 	20, 			35, 	FALSE, 	2,	DAMAGE_FLAME }, //Flamethrower
    ...
    { "Bomb", 			10,	150,			90,	TRUE,	0,	DAMAGE_BLAST }, //Stealth Floaters
    ...
    { "Fire Rocket", 		150, 	1, 			20, 	TRUE, 	100,	DAMAGE_FLAME }, //Fire Bazooka
    { "Shotgun Shell", 		70, 	7, 			20, 	FALSE, 	30,	DAMAGE_BULLETS }, //Shotgun
    { "Machinegun", 		20, 	5, 			20, 	FALSE, 	2,	DAMAGE_BULLETS }, //Mechs
    ...
    { "X-Ray",			0,	0,			0,	FALSE,	0,	-1 }, //XRay van
...
{//	     Name     System  Gravity      Z Value         Terrain   		Description
	...
	{ "Game Arena",	0,	3,	Z_PAINTBALL,	TERRAIN_PAINTBALL,	"" },
	{ NULL,		0,	0,	0,		0,			"" },
};
...
const struct shop_type shop_table[] =
{
  ...
  { "Jeep", 		VEHICLE_JEEP,		BUILDING_GARAGE, 	1,	500,	1000,	1000,	200,	6,	2,	0,	"Better than nothing." },
  { "Medium Tank", 	VEHICLE_TANK,		BUILDING_GARAGE, 	1,	2000,	3000,	500,	20,	5,	2,	0,	"Can deal some building damage." },
  { "Mark II Tank", 	VEHICLE_TANK,		BUILDING_GARAGE, 	2,	3000,	4500,	500,	20,	5,	4,	0,	"Better armor and range than the medium tank." },
  { "Mark III Tank", 	VEHICLE_TANK,		BUILDING_GARAGE, 	3,	4000,	6000,	500,	20,	5,	4,	0,	"Superior armor." },
  ...
  { "Old Boat",		VEHICLE_BOAT,		BUILDING_SHIPYARD,	1,	400,	50,	500,	0,	-1,	0,	VEHICLE_SWIM,	"It will get you across the ocean, no more." },
  { "Gunship",		VEHICLE_GUNSHIP,	BUILDING_SHIPYARD,	1,	3000,	500,	800,	100,	6,	2,	VEHICLE_SWIM,	"Can do some moderate damage." },
  { "Aircraft Carrier", VEHICLE_CARRIER,	BUILDING_SHIPYARD,	1,	9000,	2000,	10000,	0,	-1,	0,	VEHICLE_SWIM,	"You can land an aircraft in it." },
